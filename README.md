...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,877 | 🐛 106 | 📅 2026-09-02, [awesome-gulp](https://github.com/alferov/awesome-gulp) ⭐ 624 | 🐛 4 | 🌐 JavaScript | 📅 2022-04-12 and some other awesome lists.
...
* [gradle-errorprone-plugin](https://github.com/tbroyer/gradle-errorprone-plugin) ⭐ 405 | 🐛 2 | 🌐 Java | 📅 2026-09-04 - Use the [error-prone](https://github.com/google/error-prone) ⭐ 7,232 | 🐛 527 | 🌐 Java | 📅 2026-09-04 compiler for Java.
...
* [gradle-versions-plugin](https://github.com/ben-manes/gradle-versions-plugin) ⭐ 4,082 | 🐛 66 | 🌐 Groovy | 📅 2026-09-04 - Provide a task to determine which dependencies have updates.
...
* [build-info](https://github.com/jfrogdev/build-info) ⭐ 153 | 🐛 43 | 🌐 Java | 📅 2026-09-07 - Artifactory's open integration layer for the CI servers and build tools.
...
* [GitHub Repository](https://github.com/gradle/gradle) ⭐ 18,830 | 🐛 3,487 | 🌐 Groovy | 📅 2026-09-07
